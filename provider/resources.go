...
import (
	...
	dbtcloud "github.com/gthesheep/terraform-provider-dbt-cloud/pkg/provider"
)
...
const (
	...
	mainPkg = "dbtcloud"
	// modules:
	mainMod = "index" // the dbt-cloud module
)
...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		Keywords:   []string{"pulumi", "dbt-cloud", "category/cloud"},
		License:    "Apache-2.0",

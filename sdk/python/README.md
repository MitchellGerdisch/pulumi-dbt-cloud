...
1. Run the following command to update files to use the name of your provider (third-party: use your GitHub organization/username):
   ...
   - find and replace all instances of the boilerplate `dbt-cloud` with the `NAME` of your provider.
...
before:
  ...
  - make tfgen
builds:
- binary: pulumi-resource-dbt-cloud
  dir: provider
  goarch:
  - amd64
  - arm64
  ...
  ignore: []
  ldflags:
  - -X github.com/pulumi/pulumi-dbt-cloud/provider/pkg/version.Version={{.Tag}}
  main: ./cmd/pulumi-resource-dbt-cloud/
  sort: asc
  use: git
release:
  disable: false
...
├── config.yaml
├── metadata.json
├── pulumi-dbt-cloud_darwin_amd64_v1
│   └── pulumi-resource-dbt-cloud
├── pulumi-dbt-cloud_darwin_arm64
│   └── pulumi-resource-dbt-cloud
├── pulumi-dbt-cloud_linux_amd64_v1
│   └── pulumi-resource-dbt-cloud
├── pulumi-dbt-cloud_linux_arm64
│   └── pulumi-resource-dbt-cloud
├── pulumi-dbt-cloud_windows_amd64_v1
│   └── pulumi-resource-dbt-cloud.exe
└── pulumi-dbt-cloud_windows_arm64
    └── pulumi-resource-dbt-cloud.exe
```

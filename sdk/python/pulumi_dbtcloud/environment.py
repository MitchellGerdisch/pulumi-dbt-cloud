...
class EnvironmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] dbt_version: Version number of dbt to use in this environment
        ...
        :param pulumi.Input[int] credential_id: Credential ID to create the environment with

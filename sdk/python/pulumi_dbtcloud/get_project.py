...
class GetProjectResult:
    ...
    """
    def __init__(__self__, connection_id=None, id=None, name=None, project_id=None, repository_id=None, state=None):
...
def get_project(project_id: Optional[int] = None,
...
def get_project_output(project_id: Optional[pulumi.Input[int]] = None,

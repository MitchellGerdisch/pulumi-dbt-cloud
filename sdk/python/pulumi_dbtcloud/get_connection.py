...
class GetConnectionResult:
    ...
    """
    def __init__(__self__, account=None, allow_keep_alive=None, allow_sso=None, connection_id=None, database=None, id=None, is_active=None, name=None, project_id=None, role=None, type=None, warehouse=None):
...
def get_connection(connection_id: Optional[int] = None,
    ...
    return AwaitableGetConnectionResult(
        ...
        allow_keep_alive=__ret__.allow_keep_alive,
        allow_sso=__ret__.allow_sso,

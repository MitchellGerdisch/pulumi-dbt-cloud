...
class GetJobResult:
    ...
    """
    def __init__(__self__, deferring_job_id=None, environment_id=None, id=None, job_id=None, name=None, project_id=None, self_deferring=None, timeout_seconds=None, triggers=None):
...
def get_job(job_id: Optional[int] = None,
    ...
    return AwaitableGetJobResult(
        deferring_job_id=__ret__.deferring_job_id,
        environment_id=__ret__.environment_id,
        id=__ret__.id,
        job_id=__ret__.job_id,
        name=__ret__.name,
        project_id=__ret__.project_id,
        self_deferring=__ret__.self_deferring,
        timeout_seconds=__ret__.timeout_seconds,

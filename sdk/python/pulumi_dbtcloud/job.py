...
class JobArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[bool]]] triggers: Flags for which types of triggers to use, keys of github_webhook, git_provider_webhook, schedule, custom_branch_only
        :param pulumi.Input[str] dbt_version: Version number of DBT to use in this job
        :param pulumi.Input[int] deferring_job_id: Job identifier that this job defers to
...
class Job(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            target_name: Optional[pulumi.Input[str]] = None,
            timeout_seconds: Optional[pulumi.Input[int]] = None,
            triggers: Optional[pulumi.Input[Mapping[str, pulumi.Input[bool]]]] = None) -> 'Job':
        """
